...
# Keypoints from posenet model's single pose estimation
kp = {
...
for i in range(len(kp["keypoints"])-2):
	cv2.circle(canny, (int(kp["keypoints"][i]["position"]["x"]),int(kp["keypoints"][i]["position"]["y"])),3,(255,255,255),-1)
